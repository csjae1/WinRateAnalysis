...
```{r}
# Batter Data
corrplot.mixed(cor(analysis.pit), p.mat = cor(analysis.pit), sig.level = 0.5, tl.pos = "lt", tl.col = "black")
# R/G, Rbat, RBI, SLG, OPS, TB, Hbat, PA, BAbat, BBbat, HRbat, 2Bbat, AB, SF, CS, SObat, SH > 0.5


# Pitcher Data
corrplot.mixed(cor(analysis.bat), p.mat = cor(analysis.bat), sig.level = 0.5, tl.pos = "lt", tl.col = "black")
